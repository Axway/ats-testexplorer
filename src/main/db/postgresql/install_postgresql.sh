...
CURRENT_DB_VERSION=4.0.11

function print_help() {
  echo "The usage is ${0} [OPTION] [VALUE] ...
The following script installs an ATS Logging DB for storing test execution results. The current DB script version is $CURRENT_DB_VERSION"
