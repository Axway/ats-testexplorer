...
public class TestExplorerPGDbWriteAccess extends PGDbWriteAccess implements TestExplorerDbWriteAccessInterface {

    private static final Logger LOG = Logger.getLogger( TestExplorerPGDbWriteAccess.class );
    
    public TestExplorerPGDbWriteAccess( DbConnPostgreSQL dbConnection ) throws DatabaseAccessException {
