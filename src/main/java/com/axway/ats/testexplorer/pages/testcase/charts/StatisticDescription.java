...
public class StatisticDescription implements Serializable {
     ...
     *  - action queue name when working with HTF actions
     */
    ...
    public StatisticDescription( int statisticId,
                                 int testcaseId,
                                 String testcaseName,
        ...
        this.statisticIds.add( statisticId );
    ...
    public StatisticDescription( Set<Integer> statisticIds,
                                 int testcaseId,
                                 String testcaseName,
                                 int machineId,
                                 String machineName,
    ...
    public StatisticDescription newInstance() {

        return new StatisticDescription( this.getStatisticIds(),
                                         this.testcaseId,
                                         this.testcaseName,
                                         this.machineId,
                                         this.machineName,
