...
public class RunCopyPage extends BaseCopyPage {
    ...
    protected String generateThreadIdentifier() {
        ...
        return "copy_run_" + sourceHost + "_" + sourceDbName + "_" + runIdString + "_to_" + destinationHost
               + "_" + destinationDbName;
    }
    ...
    protected CopyJobThread getNewCopyThread( String threadIdentifier ) {
        ...
        CopyJobThread copyJobThread = new CopyRunJobThread( sourceHost, sourceDbName,
                                                            Integer.parseInt( runIdString ), destinationHost,
