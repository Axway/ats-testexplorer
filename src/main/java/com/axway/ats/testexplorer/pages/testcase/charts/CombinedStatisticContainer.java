...
public class CombinedStatisticContainer extends StatisticContainer {
    ...
    private Map<Integer, StatisticDescription> combinedStatDescriptions;
    ...
    public CombinedStatisticContainer( int containerIndexInDataPanel,
        ...
        this.combinedStatDescriptions = new TreeMap<Integer, StatisticDescription>();
    }

    @Override
    public List<StatisticDescription> getStatDescriptions() {

        return new ArrayList<StatisticDescription>( combinedStatDescriptions.values() );
    }

    public StatisticDescription addCombinedStatisticDescription(
                                                                 StatisticDescription statDescription ) {

        StatisticDescription combinedStatDescription = null;
        for( StatisticDescription description : combinedStatDescriptions.values() ) {
