...
public class MachineDescription implements Serializable {
    ...
    private Map<String, StatisticDescription> statDescriptionsMap;
    ...
    public MachineDescription( int testcaseId,
        ...
        this.statDescriptionsMap = new HashMap<String, StatisticDescription>();
    ...
    public List<StatisticDescription> getStatDescriptionsList() {

        List<StatisticDescription> statDescriptions = new java.util.ArrayList<StatisticDescription>();
     ...
     * @return
     */
    public StatisticDescription getActualStatisticInfoForThisMachine(
                                                                      StatisticDescription statDescription ) {
    ...
    public MachineDescription newSimpleInstance() {
        ...
        MachineDescription newMachineDescription = new MachineDescription( this.testcaseId,
                                                                           ...
                                                                           this.globalPanel,
                                                                           this.isComparing );
        for( StatisticDescription statDescription : this.statDescriptionsMap.values() ) {
