...
public class MessagesPanel extends Panel {
    ...
    public MessagesPanel( String wicketId,
        ...
        if( isRun ) {
            grid = new MainDataGrid( "messagesTable",
                                     new RunMessagesDataSource( this ),
                                     columns,
                                     columnDefinitions,
                                     "Run Messages" );
            idColumnName = "runId";
            ...
            grid = new MainDataGrid( "messagesTable",
                                     new SuiteMessagesDataSource( this ),
                                     columns,
                                     columnDefinitions,
                                     "Suite Messages" );
